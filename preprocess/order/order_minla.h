...
//模拟退火进程，具有给定的步骤、能量和标准 tp 优化Simulated annealing procedure with given steps, energy and norm tp optimise
...
void annealing_parametrise(std::ofstream &output, const Adjlist &g, const int range, const int repetitions,const double E_min, const double E_max, double norm(double));
