...
// https://stackoverflow.com/questions/8848575/fastest-way-to-reset-every-value-of-stdvectorint-to-0/8849789#8849789
...
vector<ul> Uadjlist::compute_degrees(Edgelist &g) 
{ 
	// warning: if input file is directed, edges may be counted twice
	vector<ul> deg;
	if(g.deg_computed) {
